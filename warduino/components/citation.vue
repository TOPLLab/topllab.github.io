<template>
  <div class="container">
    ...
    <ul>
        ...
        <li class="active"><button class="tab"><span>BibTex</span></button></li>
    </ul>
    ...
    <form class="copy-text">
        ...
        <svg aria-hidden="true" height="100%" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="">
